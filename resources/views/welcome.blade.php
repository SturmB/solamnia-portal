...
<head>
    ...
    <style>
        ...
        @media (prefers-reduced-motion: no-preference) {
            ...
            .beam-grow {
                animation: beam-warm 1900ms cubic-bezier(0.16, 1, 0.3, 1) both,
                    beam-breathe 5.5s ease-in-out 1900ms infinite;
                transform-origin: 50% 0;
            }
            ...
            .beam-lens {
                animation: lens-flare 1500ms ease-out both;
            }

            .beam-pool {
                animation: fx-fade 1200ms ease-out both;
            }
            ...
            @keyframes beam-warm {
                0% {
                    opacity: 0;
                    transform: scaleY(0.38) scaleX(0.75);
                }
...
<body class="bg-screen text-ink min-h-svh font-sans">
    <main class="relative isolate flex min-h-svh flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <div aria-hidden="true" class="pointer-events-none absolute inset-0 -z-10 opacity-[0.10] mix-blend-soft-light"
            style="background-image:url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22120%22 height=%22120%22%3E%3Cfilter id=%22n%22%3E%3CfeTurbulence type=%22fractalNoise%22 baseFrequency=%220.8%22 numOctaves=%222%22 stitchTiles=%22stitch%22/%3E%3C/filter%3E%3Crect width=%22100%25%22 height=%22100%25%22 filter=%22url(%23n)%22/%3E%3C/svg%3E');background-size:120px;">
        </div>
        ...
        <div aria-hidden="true" class="pointer-events-none absolute inset-0 -z-20"
            style="background:
                ...
                linear-gradient(to bottom, transparent 55%, oklch(0.11 0.02 296 / 0.45));">
        </div>

        <img src="{{ asset('images/solamnia-wordmark-white.png') }}" alt="Solamnia" width="737" height="114"
            class="fx-rise d1 h-11 w-auto sm:h-14" style="filter: drop-shadow(0 0 30px oklch(0.72 0.15 296 / 0.45));">

        <p class="fx-rise d2 font-display-sc mt-8 text-balance text-lg tracking-[0.12em] text-[oklch(0.82_0.02_296)]">
        ...
        <div class="fx-rise d3 mt-10 flex flex-col items-center gap-5">
            @auth
                ...
                <a href="{{ route('dashboard') }}"
                    class="btn-cta focus-visible:ring-violet-lit focus-visible:ring-offset-screen inline-flex items-center rounded-lg px-8 py-3 font-medium text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-4">
                    Enter
                </a>
            @else
                <a href="{{ route('login') }}"
