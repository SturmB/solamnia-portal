...
<div class="space-y-6 rounded-xl border border-zinc-200 py-6 shadow-sm dark:border-white/10" wire:cloak
    ...
    <div class="px-6">
        ...
        <div x-show="showRecoveryCodes" x-transition id="recovery-codes-section" class="relative overflow-hidden"
            ...
            <div class="mt-3 space-y-3">
                ...
                @if (filled($recoveryCodes))
                    <div class="grid gap-1 rounded-lg bg-zinc-100 p-4 font-mono text-sm dark:bg-white/5" role="list"
